using UnityEngine;
[System.Serializable] public class DialogueLine { public string speaker; public string text; public int portraitNum = 0; public string cameraName = ""; public float blendSpeed = 1.0f; }
