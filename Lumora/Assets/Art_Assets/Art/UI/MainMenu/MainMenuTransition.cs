...
/// References are assigned at runtime by UIManager.OnMainMenuStartClick().
...
public class MainMenuTransition : MonoBehaviour
{
    ...
    public float holdOnImage2Duration = 2.0f;  // Time for illustration 2
    public float illustration2FadeDuration = 3.0f;  //Time fade duration
